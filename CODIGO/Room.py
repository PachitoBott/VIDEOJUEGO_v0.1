...
ENCOUNTER_TABLE: list[tuple[int, list[list[Type[Enemy]]]]] = [
    (
        ...
        [
            ...
            [FastChaserEnemy, BasicEnemy],
            [FastChaserEnemy, BasicEnemy, FastChaserEnemy],
            [FastChaserEnemy, BasicEnemy, BasicEnemy],
        ],
    ),
    (
        4,
        [
            [FastChaserEnemy, FastChaserEnemy, BasicEnemy],
            [FastChaserEnemy, FastChaserEnemy, FastChaserEnemy],
            [FastChaserEnemy, BasicEnemy, BasicEnemy],
            [FastChaserEnemy, BasicEnemy, BasicEnemy, FastChaserEnemy],
        ],
    ),
    (
        6,
        [
            ...
            [FastChaserEnemy, TankEnemy, FastChaserEnemy],
            [TankEnemy, BasicEnemy, FastChaserEnemy],
            [FastChaserEnemy, FastChaserEnemy, FastChaserEnemy, BasicEnemy],
        ],
    ),
    (
        8,
        [
            [TankEnemy, TankEnemy, FastChaserEnemy, FastChaserEnemy],
            [TankEnemy, FastChaserEnemy, FastChaserEnemy, BasicEnemy],
            [TankEnemy, FastChaserEnemy, FastChaserEnemy, FastChaserEnemy],
            [TankEnemy, FastChaserEnemy, BasicEnemy, FastChaserEnemy],
        ],
    ),
    (
        10,
        [
            [ShooterEnemy, FastChaserEnemy, FastChaserEnemy],
            [TankEnemy, FastChaserEnemy, FastChaserEnemy, FastChaserEnemy],
            [ShooterEnemy, TankEnemy, FastChaserEnemy, FastChaserEnemy],
            [TankEnemy, TankEnemy, FastChaserEnemy, FastChaserEnemy],
            [FastChaserEnemy, FastChaserEnemy, FastChaserEnemy, FastChaserEnemy],
            [TankEnemy, FastChaserEnemy, BasicEnemy, FastChaserEnemy],
        ],
    ),
]
